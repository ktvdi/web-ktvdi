...
<head>
    ...
    <!-- Favicon lokal -->
    <link rel="icon" href="{{ url_for('static', filename='images/ktvdi.png') }}" type="image/png">

    <!-- CSS -->
    <link rel="stylesheet" href="{{ url_for('static', filename='css/style.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">

    <!-- Manifest (HARUS dari static) -->
...
<body class="{% block body_class %}default-page{% endblock %}">
    <header>
        ...
        <div class="logo">
            <!-- LOGO HARUS LOKAL — SUDAH DIBENERIN -->
            <img src="{{ url_for('static', filename='images/ktvdi.png') }}" alt="Logo KTVDI">
        </div>
