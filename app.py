...
app = Flask(__name__)
CORS(app)
# Secret key default jika tidak ada di .env (Mencegah error session)
app.secret_key = os.environ.get("SECRET_KEY", "dev-secret-key-ktvdi-2026")
...
if GOOGLE_API_KEY:
    ...
    print("⚠️ Warning: GEMINI_APP_KEY tidak ditemukan di .env")

# --- 3. KONFIGURASI FIREBASE (DENGAN SAFETY CHECK) ---
ref = None
try:
    ...
    if os.environ.get("FIREBASE_PROJECT_ID"):
        ...
        print("⚠️ Warning: Firebase Credentials tidak lengkap di .env")
...
def forgot_password():
    # Logika sama seperti sebelumnya, dipersingkat untuk hemat karakter di sini
    # tapi fungsionalitas tetap ada
