...
# --- PERBAIKAN KONEKSI FIREBASE (AGAR TIDAK ERROR DI VERCEL) ---
# Vercel tidak bisa membaca file 'credentials.json' secara fisik.
# Kita harus menggunakan Environment Variables.
try:
    cred = None
    ...
    # Jika tidak ada ENV, coba cari file json (untuk localhost)
